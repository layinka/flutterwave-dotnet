...
namespace Flutterwave.Net
{
    public class Payments : IPayments
    {
        ...
        /// </param>
        /// <returns>A hosted link with the payment details</returns>
        public Task<InitiatePaymentResponse> InitiatePaymentAsync(string referenceNumber,
                                                       decimal amount,
                                                       string redirectUrl,
                                                       string customerName,
                                                       string customerEmail,
                                                       ...
                                                       List<SplitPaymentRequest> splitPaymentRequests = null)
        {
            ...
            return _flutterwaveApi.PostAsync<InitiatePaymentResponse>(Endpoints.PAYMENTS, data);
        }
